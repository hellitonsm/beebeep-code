...
void GuiMain::showLicense()
{
  ...
  "BeeBEEP Copyright (C) 2010-2023 Marco Mastroddi <br><br>"
  "BeeBEEP is free software: you can redistribute it and/or modify "
  "it under the terms of the GNU General Public License as published "
  "by the Free Software Foundation, either version 3 of the License "
...
void GuiMain::createToolAndMenuBars()
{
  ...
  QString label_tooltip = QString( "BeeBEEP %1 %2" ).arg( Settings::instance().version( true, true, true ), Settings::instance().operatingSystem( true ) );
